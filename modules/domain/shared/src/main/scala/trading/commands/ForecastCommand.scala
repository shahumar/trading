...
enum ForecastCommand derives Codec.AsObject, Eq, Show:
  ...
  case Register(id: CommandId, cid: CorrelationId, authorName: AuthorName, authorWebsite: Option[Website], createdAt: Timestamp)

  case Publish(id: CommandId, cid: CorrelationId, authorId: AuthorId, symbol: Symbol, description: ForecastDescription, tag: ForecastTag, createdAt: Timestamp)

  case Vote(id: CommandId, cid: CorrelationId, forecastId: ForecastId, result: VoteResult, createdAt: Timestamp)
