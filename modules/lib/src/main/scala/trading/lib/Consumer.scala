...
object Consumer:
  ...
  def local[F[_]: Applicative, A] (queue: Queue[F, Option[A]]): Consumer[F, A] = new:
  ...
  def kafka[F[_]: Async, A] (settings: ConsumerSettings[F, String, A], topic: String): Resource[F, Consumer[F, A]] =
